...
function buildCharts(sample) {
  ...
  var resultArray = samples.filter(sampleOnj => sampleObj.id == sample)
  ...
  var otu_labels = result.otu_labels;
    ...
    console.log("top 10 sample: " + sample_values);
    ...
    var barLayout = {
      title: "Top Bacteria Samples Collected",
      margin: {t: 30, l: 150}
    };
